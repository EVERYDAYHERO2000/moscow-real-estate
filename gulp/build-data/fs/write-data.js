...
const writeData = function(records, filename){
...
var outputStream = fileSystem.createWriteStream( DEV_PATH + `/bin/data/${filename}.json` );
...
outputStream.on(
	...
	function handleFinish() {
		...
		var inputStream = fileSystem.createReadStream( DEV_PATH + `/bin/data/${filename}.json` );
