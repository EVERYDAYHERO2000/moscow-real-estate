...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"libs/leaflet.yandex.js":[function(require,module,exports) {
...
L.Yandex = L.Layer.extend({
  options: {
    type: 'yandex#map',
    // 'map', 'satellite', 'hybrid', 'map~vector' | 'overlay', 'skeleton'
    mapOptions: {
  ...
  initialize: function initialize(type, options) {
    ...
    this._isOverlay = options.type.indexOf('overlay') !== -1 || options.type.indexOf('skeleton') !== -1;
    this._animatedElements = [];
  },
  _setStyle: function _setStyle(el, style) {
    for (var prop in style) {
      el.style[prop] = style[prop];
    }
  },
  _initContainer: function _initContainer(parentEl) {
  ...
  _setEvents: function _setEvents(map) {
    var events = {
      move: this._update
    };
  ...
  _resyncView: function _resyncView() {
    // for use in addons
    if (!this._map) {
      return;
    }
    ...
    this._map.setView(ymap.getCenter(), ymap.getZoom(), {
      animate: false
    });
  },
  ...
  _animateZoomEnd: function _animateZoomEnd() {
...
},{}]},{},["../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","libs/leaflet.yandex.js"], null)
//# sourceMappingURL=/leaflet.yandex.5921c4ac.js.map